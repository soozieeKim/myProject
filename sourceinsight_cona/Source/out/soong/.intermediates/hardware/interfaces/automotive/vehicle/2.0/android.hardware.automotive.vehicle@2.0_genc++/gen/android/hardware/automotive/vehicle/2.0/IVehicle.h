...
struct IVehicle : public ::android::hidl::base::V1_0::IBase {
    ...
    using getAllPropConfigs_cb = std::function<void(const ::android::hardware::hidl_vec<VehiclePropConfig>& propConfigs)>;
    virtual ::android::hardware::Return<void> getAllPropConfigs(getAllPropConfigs_cb _hidl_cb) = 0;

    using getPropConfigs_cb = std::function<void(StatusCode status, const ::android::hardware::hidl_vec<VehiclePropConfig>& propConfigs)>;
    ...
    using get_cb = std::function<void(StatusCode status, const VehiclePropValue& propValue)>;
    virtual ::android::hardware::Return<void> get(const VehiclePropValue& requestedPropValue, get_cb _hidl_cb) = 0;

    virtual ::android::hardware::Return<StatusCode> set(const VehiclePropValue& propValue) = 0;

    virtual ::android::hardware::Return<StatusCode> subscribe(const ::android::sp<IVehicleCallback>& callback, const ::android::hardware::hidl_vec<SubscribeOptions>& options) = 0;

    virtual ::android::hardware::Return<StatusCode> unsubscribe(const ::android::sp<IVehicleCallback>& callback, int32_t propId) = 0;
    ...
    static ::android::hardware::Return<::android::sp<IVehicle>> castFrom(const ::android::sp<IVehicle>& parent, bool emitError = false);
    static ::android::hardware::Return<::android::sp<IVehicle>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
std::string toString(const ::android::sp<IVehicle>&);
